...
namespace Juego_Hum.BD
{
    class INSERT
    {
        ...
        public bool Cuestionario(string Nombre)
        {
            try
            {
        ...
        public bool Preguntas(int Id_cuest, string Pregunta, string Respuesta, string Opcion2, string Opcion3, string Opcion4)
        {
            try
            {
